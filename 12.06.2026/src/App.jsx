...
import Demo7EventHandlinge from './component/Demo7EventHandling'
          ...
          <div className='border-r'>
            <div className='sidebar-list'>
              {demolar.map((demo)=>(
                ...
                className={selectedDemo===demo.id?"bg-blue-500 text-white":"bg-gray-100"}>{demo.ad}</button>
